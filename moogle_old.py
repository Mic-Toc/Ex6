...
# my_url = "Mozilla/5.0 (X11; Linux x86_64; rv:109.0) Gecko/20100101Firefox/115.0"
...
def main():
    ...
    if args[1] == "crawl":
        ...
        QUERY = args[2]
        i = 3
        while not args[i].endswith(".pickle"):
            QUERY += " "
            QUERY += args[i]
            i += 1
        RANKING_DICT_FILE = args[i]
        WORDS_DICT_FILE = args[i+1]
        MAX_RESULTS = args[i+2]
